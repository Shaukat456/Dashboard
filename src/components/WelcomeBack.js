...
const WelcomeBack = () => {
  ...
  <div class="lg:container mx-auto flex md:p-10 sm:p-8 p-4 sm:flex-row  items-center">
    <div class="lg:flex-grow sm:flex flex-col items-start text-left lg:flex  mb-10 md:mb-0 items-cenr tet-center ">
    ...
    <div class="z-0  lg:w-6/6 md:w-1/2 w-5/6 flex -space-x-8 justify-end ">
        <figure>
          <img src={require("../image.png")} alt=""  className=' lg:w-10/12 md:w-7/12 w-6/12 mx-16'/>
        </figure>
