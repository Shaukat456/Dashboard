...
const WelcomeBack = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2   lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left lg:flex  mb-16 md:mb-0 items-center text-center ">
      <h1 class="title-font lg:text-7xl    sm:text-4xl  text-2xl font-bold text-gray-600 font-CardH md:text-4xl">Welcome Back! 
        {/* <br class="hidden lg:inline-block"readymade gluten   /> */}
      </h1>
      <h1 class=" font-CardH   title-font   mb-4  text-gray-600  text-2xl lg:text-7xl  md:text-4xl   sm:text-4xl font-bold">Minimal UI
        {/* <br class="hidden lg:inline-block"readymade gluten   /> */}
      </h1>
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 flex ">
        <svg></svg>
      <img class="object-cover object-center rounded" alt="hero" src="https://minimals.cc/assets/illustrations/characters/character_3.png"/>
    </div>
  </div>
</section>
    </div>
