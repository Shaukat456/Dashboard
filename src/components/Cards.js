...
const Cards = ({ total=2, qty = '18,500', percentg = 2.5, arrow, color='yellow' }) => {
  return (
    // <div classNameName="font-CardH  ">
      <div className="w-full   md:p-6 sm:p-4 p-3  flex flex-wrap  justify-center  bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-gray-800 dark:border-gray-700  ">
        ...
        See our guideline
          ...
          {/* </div> */}
          <h1 className="font-CardH font-semibold text-3xl text-gray-700 "> {qty} </h1>
        </div>
